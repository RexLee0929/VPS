...
install_nezha_agent() {
  echo "安装哪吒探针..."
  curl -L https://raw.githubusercontent.com/nezhahq/scripts/main/agent/install.sh -o nezha.sh && chmod +x nezha.sh && env NZ_SERVER="${nezha_panel_ip}:${nezha_panel_port}" NZ_TLS="${tls_option}" NZ_CLIENT_SECRET="${nezha_agent_key}" ./nezha.sh
}
